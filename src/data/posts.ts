...
export const INTIAL_POSTS: Post[] = [
  {
    ...
    content: 'Implement RESTful principles with proper status codes, versioning, and HATEOAS. Use OpenAPI/Swagger for documentation.',
    comments: [
      {
        id: 1,
        author: 'Lead Architect',
        content: 'Consider adding circuit breakers for fault tolerance in distributed systems.',
  ...
  },
  {
    ...
    content: 'Leverage utility types (Pick/Omit), type guards, and discriminated unions for type-safe architectures.',
    comments: [
      {
        id: 1,
        author: 'TS Expert',
  ...
  },
  {
    ...
    content: 'Focus on readability, maintainability, and architecture patterns. Use checklist-driven approaches for consistency.',
    comments: [
      {
        id: 1, author: 'Engineering Manager', content: 'Implement automated code quality gates in CI pipeline.', timestamp: '2024-02-12T16:20:00',
        postId: 0
      },
      {
        id: 2, author: 'Senior Dev', content: 'Peer review pairing improves knowledge sharing.', timestamp: '2024-02-12T17:00:00',
        postId: 0
      }
    ],
    timestamp: ""
  },
  {
    ...
    comments: [
      {
        id: 1, author: 'DevOps', content: 'Consider parallel test execution for faster feedback.', timestamp: '2024-02-11T10:30:00',
        postId: 0
      }
    ],
    timestamp: ""
  },
  {
    ...
    content: 'Master useEffect dependencies, useMemo/useCallback optimization, and custom hook composition patterns.',
    comments: [
      {
        id: 1,
  ...
  },
  {
    ...
    content: 'Implement JWT with RSA256, refresh tokens, and API gateway validation for distributed systems security.',
    comments: [
      {
        id: 1, author: 'Security Lead', content: 'Rotate keys quarterly and monitor JWT leakage.', timestamp: '2024-02-09T09:45:00',
        postId: 0
      }
    ],
    timestamp: ""
  ...
  },
  {
    ...
    content: 'Chrome DevTools audits, React memoization, and Webpack bundle analysis techniques.',
    comments: [
      {
        id: 1,
  ...
  },
  {
    ...
    content: 'OWASP Top 10 mitigation: sanitize inputs, CSP headers, and dependency vulnerability scanning.',
    comments: [
      {
        id: 1,
        author: 'CISO',
